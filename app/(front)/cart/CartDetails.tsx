...
export default function CartDetails() {
    ...
    const { items, addCart, increase, decrease, removeCart, itemsPrice } = useCartService();
    ...
    return (
      <>
        ...
        {items.length === 0 ? (
          <div>
            Sepetinizde ürün yok. <Link href="/">Alışverişe devam et</Link>
          </div>
        ) : (
              ...
              <div className="space-y-5 sticky top-5">
                <div className="bg-white drop-shadow rounded-lg space-y-2.5 p-5">
                  ...
                  <p className="text-sm font-medium text-muted-foreground">
                    Kargo, vergi ve kupon kodları sonraki aşamada
                    hesaplanacaktır.
                  </p>
                </div>
                <Button size="lg" className="w-full text-base font-semibold drop-shadow" onClick={() => router.push("/checkout")}>
                  Sepeti Onayla
