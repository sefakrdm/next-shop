...
import { Check, CheckCircle, CircleNotch, Warning } from "@phosphor-icons/react/dist/ssr";
          ...
          <div className="realative w-[450px] bg-white drop-shadow-md p-10 rounded-xl">
            ...
            {params.get("success") && (
              <Alert className="mb-5 border-green-600 bg-green-600/5 text-green-600">
                <CheckCircle size={18} weight="duotone" color="green" className="text-green-600" />
