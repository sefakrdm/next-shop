...
import { IReview } from '@/lib/models/ReviewModel';
            ...
            <div className="flex items-center justify-between gap-10 my-5">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <Button
                        variant="outline"
                        size="sm"
                        className={cn("text-xs font-semibold", filterReview === null && "border-primary bg-primary/5")}
                    ...
                    {[5, 4, 3, 2, 1].map((rate) => (
                        <Button
                            ...
                            variant="outline"
                            size="sm"
                            className={cn(filterReview === rate && "border-primary bg-primary/5")}
                        ...
                        >
                            <ReactRating
                                ...
                                readOnly
                            />
                            <span className="text-xs font-semibold ml-1">({getReviewCount(rate)})</span>
                        </Button>
                    ))}
                </div>
            </div>
                    ...
                    filteredReviews.map((review, index) => (
                        ...
                        >
                            <div className="flex items-center justify-between">
                                ...
                                <div className='text-sm font-medium'>{moment(review.createdAt).format("LL")}</div>
                            </div>
